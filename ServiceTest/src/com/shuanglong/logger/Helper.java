...
/**
 * Helper util class to be used instead of Android methods to avoid direct
 * dependency and enable unit testing on Android projects.
 */
final class Helper
{
	 ...
	 *
	 *         NOTE: Logic slightly change due to strict policy on CI - "Inner
