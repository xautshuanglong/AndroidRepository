...
final class LoggerPrinter implements Printer
{
	...
	private static final String DEFAULT_TAG = "Shuanglong";
	 ...
	 * Drawing toolbox
	 */
	private static final String TOP_LEFT_CORNER = "¨X";
	private static final String BOTTOM_LEFT_CORNER = "¨^";
	private static final String MIDDLE_CORNER = "¨c";
	private static final String HORIZONTAL_DOUBLE_LINE = "¨U";
	private static final String DOUBLE_DIVIDER = "¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T";
	...
	private void logHeaderContent(int logType, String tag, int methodCount)
	{
		...
		for (int i = methodCount; i > 0; i--)
		{
			...
			builder.append("¨U ").append(getSimpleClassName(trace[stackIndex].getClassName())).append(".")
